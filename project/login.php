...
<head>
  ...
  <title>Система составления расписания</title>
  		...
  		<div id="login" class="col-md-4">
  			<div class="card">
  				<div class="card-body">
  					...
  					<form id="login-form" >
					  <h4><b>Добро пожаловать в систему составления расписания</b></h4>
  						...
  						<center><button class="btn-sm btn-block btn-wave col-md-4 btn-primary">Вход</button></center>
  					</form>
  				</div>
  			</div>
  		</div>
